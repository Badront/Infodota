...
UNION ALL SELECT '2','blades_of_attack','armaments','450','Blades of Attack'
...
UNION ALL SELECT '10','quarterstaff','armaments','900','Quarterstaff'
...
UNION ALL SELECT '182','stout_shield','armaments','250','Stout Shield'
...
UNION ALL SELECT '24','ultimate_orb','attributes','2100','Ultimate Orb'
...
UNION ALL SELECT '32','talisman_of_evasion','arcane','1800','Talisman of Evasion'
UNION ALL SELECT '33','cheese',null,'1000','Cheese'
UNION ALL SELECT '34','magic_stick','arcane','200','Magic Stick'
UNION ALL SELECT '36','magic_wand','common','500','Magic Wand'
UNION ALL SELECT '37','ghost','arcane','1600','Ghost Scepter'
UNION ALL SELECT '38','clarity','consumable','50','Clarity'
UNION ALL SELECT '39','flask','consumable','110f','Healing Salve'
UNION ALL SELECT '40','dust','consumable','180','Dust of Appearance'
UNION ALL SELECT '41','bottle','consumable','700','Bottle'
UNION ALL SELECT '42','ward_observer','consumable','150','Observer Ward'
...
UNION ALL SELECT '50','phase_boots','common','1350','Phase Boots'
...
UNION ALL SELECT '56','ring_of_health','secret_shop','875','Ring of Health'
UNION ALL SELECT '57','void_stone','secret_shop','875','Void Stone'
UNION ALL SELECT '58','mystic_staff','secret_shop','2700','Mystic Staff'
UNION ALL SELECT '59','energy_booster','secret_shop','1000','Energy Booster'
...
UNION ALL SELECT '67','oblivion_staff','common','1675','Oblivion Staff'
UNION ALL SELECT '69','pers','common','1750','Perseverance'
UNION ALL SELECT '71','poor_mans_shield','common','550','Poor Man''s Shield'
...
UNION ALL SELECT '81','vladmir','support','2050','Vladmir''s Offering'
...
UNION ALL SELECT '98','orchid','caster','5025','Orchid Malevolence'
...
UNION ALL SELECT '125','vanguard','armor','2225','Vanguard'
UNION ALL SELECT '127','blade_mail','armor','2200','Blade Mail'
UNION ALL SELECT '129','soul_booster','armor','3300','Soul Booster'
...
UNION ALL SELECT '139','butterfly','weapons','6000','Butterfly'
UNION ALL SELECT '141','greater_crit','weapons','5550','Daedalus'
UNION ALL SELECT '143','basher','weapons','2950','Skull Basher'
UNION ALL SELECT '145','bfury','weapons','4350','Battle Fury'
UNION ALL SELECT '147','manta','armor','4950','Manta Style'
UNION ALL SELECT '149','lesser_crit','weapons','2150','Crystalys'
UNION ALL SELECT '151','armlet','weapons','2400','Armlet of Mordiggian'
...
UNION ALL SELECT '156','satanic','artifacts','6150','Satanic'
...
UNION ALL SELECT '168','desolator','artifacts','4100','Desolator'
...
UNION ALL SELECT '176','ethereal_blade','weapons','4900','Ethereal Blade'
UNION ALL SELECT '178','soul_ring','common','800','Soul Ring'
UNION ALL SELECT '180','arcane_boots','support','1450','Arcane Boots'
...
UNION ALL SELECT '190','veil_of_discord','caster','2675','Veil of Discord'
...
UNION ALL SELECT '242','crimson_guard','armor','3850','Crimson Guard';