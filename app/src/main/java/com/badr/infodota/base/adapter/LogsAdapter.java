...
import com.badr.infodota.base.api.trackdota.GameManager;
import com.badr.infodota.base.api.trackdota.TrackdotaUtils;
import com.badr.infodota.base.api.trackdota.core.Player;
import com.badr.infodota.base.api.trackdota.game.Team;
import com.badr.infodota.base.api.trackdota.live.LogEvent;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (object instanceof LogEvent) {
            ...
            if ("kill".equals(logEvent.getAction())) {
                ...
                Glide.with(context).load(Utils.getHeroMiniImage(hero.getDotaId())).placeholder(0).into(holder.heroIcon);
                ...
                Glide.with(context).load(Utils.getItemImage(item.getDotaId())).placeholder(0).into(holder.itemIcon);
