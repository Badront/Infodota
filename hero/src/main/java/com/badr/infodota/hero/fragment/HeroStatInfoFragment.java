 ...
 * Time: 14:43
 */
public class HeroStatInfoFragment extends Fragment implements RequestListener<MediaPlayer>, View.OnClickListener {
    private SpiceManager mSpiceManager = new SpiceManager(UncachedSpiceService.class);
    private Hero mHero;
    private GifImageView mImageView;
    private MediaPlayer mMediaPlayer;

    public static HeroStatInfoFragment newInstance(Hero hero) {
        HeroStatInfoFragment fragment = new HeroStatInfoFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mHero = (Hero) getArguments().getSerializable(Navigate.PARAM_ENTITY);
    ...
    private void initImage() {
        ...
        if (root != null) {
            ...
            if (gifFile.exists()) {
                ...
                Glide.with(context).load(HeroUtils.getHeroPortraitImage(mHero.getDotaId())).into(mImageView);
            }
        }
    }
