 ...
 * Date: 19.01.14
 */
public class HeroDefaultItemBuildFragment extends Fragment {
    private ItemBuild guide;
    private Hero hero;

    public static HeroDefaultItemBuildFragment newInstance(Hero hero) {
        HeroDefaultItemBuildFragment fragment = new HeroDefaultItemBuildFragment();
        fragment.hero = hero;
        return fragment;
    }
