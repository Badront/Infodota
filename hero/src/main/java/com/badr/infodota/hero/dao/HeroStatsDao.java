...
public class HeroStatsDao extends GeneralDao<HeroStats> {
    ...
    * */
    ...
    public HeroStats getShortHeroStats(SQLiteDatabase database, long id) {
        Cursor cursor = database.query(getTableName(), new String[]{COLUMN_ROLES, COLUMN_PRIMARY_STAT}, GeneralDao.COLUMN_ID + "=?", new String[]{String.valueOf(id)}, null, null, null);
        try {
